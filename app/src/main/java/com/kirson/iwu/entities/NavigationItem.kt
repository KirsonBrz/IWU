...
sealed class NavigationItem(var route: String, var icon: Int, var title: String) {
    ...
    object VetList : NavigationItem("vet_list", R.drawable.meet, "Ветеринары")
    object News : NavigationItem("news", R.drawable.meet, "")
    object Empty : NavigationItem("empty", R.drawable.meet, "")
